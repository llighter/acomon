...
function zPressed(){
	...
	case "whyBcSkillbox1":	//@
		//yBcSkill1();
		tackle();//재현: 이자리 주석만 지우고 함수 넣으면됨.(몸통박치기
		turnEnd();
		break;
	case "whyBcSkillbox2":	//@
		//yBcSkill2();
		skillAttack();//재현: 이자리 주석만 지우고 함수 넣으면됨.(스킬공격
		turnEnd();
		break;
	case "whyBcSkillbox3":	//@
		//yBcSkill3();
	...
	case "whyBcSkillbox4":	//@
		//yBcSkill4();
//skillLv2Attack();//재현: 이자리 주석만 지우고 함수 넣으면됨.(빈칸
		turnEnd();
		break;
	case "whyBcAcomonbox1":	//@
		//whyBcAcomon1();
//		console.log(listCount);
		checkPokemonBook(listCount-1); //재현: 이자리 주석만 지우고 함수 넣으면됨.(포켓몬 1
		tagMyMon(listCount-1);
//		console.log("태그됨" +(listCount-1));
		turnEnd();
		break;
	case "whyBcAcomonbox2":	//@
		//whyBcAcomon2();
		checkPokemonBook(listCount-1);//재현: 이자리 주석만 지우고 함수 넣으면됨.(2
		tagMyMon(listCount-1);
//		console.log("태그됨" +(listCount-1));
		turnEnd();
		break;
	case "whyBcAcomonbox3":	//@
		//whyBcAcomon3();
		checkPokemonBook(listCount-1);//재현: 이자리 주석만 지우고 함수 넣으면됨.(3
		tagMyMon(listCount-1);
//		console.log("태그됨" +(listCount-1));
		turnEnd();
		break;
	case "whyBcAcomonbox4":	//@
		//whyBcAcomon4();
		checkPokemonBook(listCount-1);//재현: 이자리 주석만 지우고 함수 넣으면됨.(4
		tagMyMon(listCount-1);
//		console.log("태그됨" +(listCount-1));
		turnEnd();
		break;
	case "whyBcAcomonbox5":	//@
		//whyBcAcomon5();
		checkPokemonBook(listCount-1);//재현: 이자리 주석만 지우고 함수 넣으면됨.(5
		tagMyMon(listCount-1);
//		console.log("태그됨" +(listCount-1));
		turnEnd();
		break;
	case "whyBcAcomonbox6":	//@
		//whyBcAcomon6();
	//	checkPokemonBook(listCount-1);  #### 버그. 없으면 불르지말아야하는데 length값처리됨.
		console.log("아마 없을거임..");
		checkPokemonBook(listCount-1);//재현: 이자리 주석만 지우고 함수 넣으면됨.(포켓몬 6
		tagMyMon(listCount-1);
		turnEnd();
		break;
	...
	case "whyBcItembox1":	//@
		//yBcItem1();
//###원래		useItem('mint');//재현: 이자리 주석만 지우고 함수 넣으면됨.(아이템 1
		store("mint");
		turnEnd();
		break;
	case "whyBcItembox2":	//@
		//yBcItem2();
//		useItem('pokeBall');//재현: 이자리 주석만 지우고 함수 넣으면됨.(아이템 2
		store("pokeBall");
		turnEnd();
		break;
	case "whyBcItembox3":	//@
		//yBcItem3();
		store("heal");//재현: 이자리 주석만 지우고 함수 넣으면됨.(아이템 3
		turnEnd();
		break;
	case "whyBcItembox4":	//@
		//yBcItem4();
		store("makeMonFree");//재현: 이자리 주석만 지우고 함수 넣으면됨.(아이템 4
		turnEnd();
		break;
	}
}
