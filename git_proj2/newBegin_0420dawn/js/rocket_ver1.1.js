...
function zPressed(){
	...
	case "whyBcSkillbox1":	//@
		//yBcSkill1();
		tackle(myMon.id, enemyMon.id);//재현: 이자리 주석만 지우고 함수 넣으면됨.(몸통박치기
		turnEnd();
		break;
	case "whyBcSkillbox2":	//@
		//yBcSkill2();
		skillAttack(myMon.id, enemyMon.id);//재현: 이자리 주석만 지우고 함수 넣으면됨.(스킬공격
		turnEnd();
		break;
	case "whyBcSkillbox3":	//@
		//yBcSkill3();
	...
	case "whyBcSkillbox4":	//@
		//yBcSkill4();
		console.log("여기는 빈칸");//재현: 이자리 주석만 지우고 함수 넣으면됨.(빈칸
		turnEnd();
		break;
...
//		console.log("태그됨" +(listCount-1));
	...
	case "whyBcItembox1":	//@
		//yBcItem1();
		useItem('mint');//재현: 이자리 주석만 지우고 함수 넣으면됨.(아이템 1
		turnEnd();
		break;
	case "whyBcItembox2":	//@
		//yBcItem2();
